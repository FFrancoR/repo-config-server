...
import com.francorachetti.citiesservice.entity.City;
import com.francorachetti.citiesservice.repository.IHotelAPI;
...
public class CityService implements ICityService {
    ...
    public CityService(IHotelAPI hotelAPI) {
    ...
    public CityDTO getCitiesHotels(String name, String country) {
        ...
        List<HotelDTO> cityHotels = hotelAPI.getHotelsByCityId(city.getCity_id());
        //createException();
        return new CityDTO(city.getCity_id(), city.getName(), city.getContinent(), city.getCountry(), city.getState(), cityHotels);
    }

    public CityDTO fallbackGetCityHotels(Throwable throwable) {
